...
export default function DigitalMarketing() {
    ...
    const item = [
        ...
        },
        {
            ...
            lineClasses: "-left-[70px] top-[20px] md:left-[178px] md:top-[50px]",
        ...
        },
        {
            ...
            lineClasses: "-left-[80px] -top-[40px] md:left-[178px] md:top-[200px]",
        ...
        },
        {
            ...
            lineCol: "w-[25px]  md:w-[0px]  md:h-[65px] mt-[1.6px] md:-mt-[105px] -ml-[12px] md:ml-[10px]",
            lineRow: "w-[120px] md:w-[280px] h-[82px] md:h-[150px] -rotate-180 md:rotate-0 border-b-2 border-r-2  -ml-[34px] md:-ml-[9px] -mt-[79px] md:-mt-[189px]",
            textAlign: "text-end"
        },
        {
            ...
            containerClasses: "left-[40px] top-[280px] md:left-[0px] md:top-[10px]",
            textClasses: "md:left-[750px] top-[2px] md:top-[330px] w-[300px] md:w-[366px] ",
            lineClasses: "left-[150px] -top-[30px] md:left-[560px] md:top-[510px]",
            arrowClasses: "rotate-320 md:rotate-45 -top-[3px] md:-top-[20px] left-[38px] md:left-[150px] ",
            lineCol: "w-[25px]  md:w-[0px]  md:h-[25px] mt-[65px] md:-mt-[105px] ml-[102px] md:ml-[312px]",
            lineRow: "w-[120px] md:w-[302px] h-[142px] md:h-[110px] -rotate-180 md:rotate-0 border-b-2 border-l-2  -ml-[128px] md:-ml-[310px] -mt-[77px] md:-mt-[189px]",
        ...
        },
        {
            ...
            containerClasses: "left-[40px] top-[280px] md:left-[0px] md:top-[10px]",
            textClasses: "md:left-[800px] top-[80px] md:top-[240px] w-[300px] md:w-[366px] ",
            lineClasses: "left-[335px] -top-[90px] md:left-[300px] md:top-[297px]",
            arrowClasses: "rotate-320 md:rotate-220 -top-[3px] md:-top-[9px] -left-[80px] md:left-[306px] ",
            lineCol: "w-[35px]  md:w-[0px]  md:h-[15px] mt-[198px] md:-mt-[75px] -ml-[129px] md:ml-[625px]",

            lineRow: "w-[73px] md:w-[180px] h-[275px] md:h-[0px] -rotate-180 md:rotate-180 border-b-2  border-l-2  -ml-[128px] md:-ml-[190px] -mt-[77px] md:-mt-[75px]",
            textAlign: "text-start"
        },
        {
            ...
            lineClasses: "left-[335px] -top-[5px] md:left-[340px] md:top-[200px]",
            arrowClasses: "rotate-320 md:rotate-220 -top-[2px] md:-top-[9px] -left-[75px] md:left-[306px] ",
            lineCol: "w-[43px]  md:w-[0px]  md:h-[15px] mt-[199px] md:-mt-[75px] -ml-[110px] md:ml-[625px]",

            lineRow: "w-[60px] md:w-[180px] h-[400px] md:h-[0px] -rotate-180 md:rotate-180 border-b-2  border-l-2  -ml-[100px] md:-ml-[190px] -mt-[200px] md:-mt-[75px]",
            textAlign: "text-start"
        },
        {
    ...
    return (
        <div className="flex flex-col justify-center items-center px-4 py-10 pb-[350px] md:pb-[192px]">
            <div className='mb-[450px] md:mb-[180px]  '>
                <SectionCover
                    heading1={'Digital'}
                    heading2={'Marketing'}
            ...
            <div className="relative w-full max-w-[1200px] flex justify-center items-center">
                <div>
                    {
                        item.map((item, i) => (
                            <TextWithLine key={i} {...item}></TextWithLine>
                        ))
                    }
                </div>

                <div className="relative">
                    <div className="flex w-[150px] md:w-[280px] h-[150px] md:h-[280px] 
                border-4 border-black rounded-full items-center justify-center 
                text-center shadow-md z-20">
                        <h2 className="text-xs md:text-3xl font-extrabold font-poppins leading-tight">
                            Digital <br /> Marketing
                        </h2>
                    </div>
                    <CircleLayout items={items}></CircleLayout>
                </div>
            </div>
        </div >
    );
